...
.list-promoted h2, .list-promoted h3, .list-promoted h4, .list-promoted h5 { font-size: 1em; font-weight: normal; margin: 0.1em 0; display: block; }
""".strip()
...
def render_markdown(md: str, css: str = DEFAULT_CSS, title: str | None = None, *, promoted: bool = False) -> str:
    ...
    * If *promoted* is true, the body gets ``class="list-promoted"`` so
      promoted h2–h5 are visually normalized to look like list items.
    """
    ...
    body_class = ' class="list-promoted"' if promoted else ""
    return (
        "<!DOCTYPE html>\n"
        '<html lang="en">\n<head>\n<meta charset="utf-8">\n'
        f"<style>\n{css}\n</style>\n</head>\n<body{body_class}>\n{body}\n</body>\n</html>\n"
